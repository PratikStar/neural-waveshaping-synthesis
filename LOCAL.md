...
--checkpoint-path /root/nws/timbre-16k-f0_di_75-static_dynamic_z_4_16 \
--checkpoint-file last-v1.ckpt \
--restore-checkpoint \
--load-data-to-memory  >> ~/logs/timbre-16k-f0_di_75-static_dynamic_z_4_16_$(date +%Y%m%d_%H%M%S).log 2>&1 &
