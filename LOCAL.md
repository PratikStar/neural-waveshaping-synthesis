...
--gin-file gin/train/train_newt.gin \
--dataset-path /root/data/nws/timbre-16k-f0_di_75 \
--checkpoint-path /root/nws/timbre-16k-f0_di_75-static_dynamic_z_4_124 \
--load-data-to-memory  >> ~/logs/timbre-16k-f0_di_75-static_dynamic_z_4_124_$(date +%Y%m%d_%H%M%S).log 2>&1 &
