...
class ControlModule(nn.Module):
    def __init__(self, control_size: int, hidden_size: int, embedding_size: int, sample_rate: int, control_hop, embedding_strategy: str = "NONE"):
        super().__init__()
        ...
        if self.embedding_strategy == "FLATTEN_LINEAR":
            ...
            self.linear_encode = nn.Linear(hidden_size * , hidden_size)
            self.con1d_decode = nn.Conv1d(1, __, kernel_size=1) # kernel size is hyperparam
