...
class GeneralDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: str = None):
        if stage == "fit":
            self.urmp_train = GeneralDataset(self.data_dir,batch_size=self.batch_size, "train", self.load_to_memory )
            print(f"length of train ds: {len(self.urmp_train)}")
            self.urmp_val = GeneralDataset(self.data_dir,batch_size=self.batch_size, "val", self.load_to_memory)
        elif stage == "test" or stage is None:
            self.urmp_test = GeneralDataset(self.data_dir,batch_size=self.batch_size "test", self.load_to_memory)
