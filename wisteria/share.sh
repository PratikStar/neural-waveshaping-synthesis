...
#--mode=train \
#--run_name=ae_single_note_distorted_sr44k \
...
#--gin_param="TFRecordProvider.file_pattern='/work/gk77/k77021/data/ddsp/tfrecord-single_note_distorted-sr44k/train.tfrecord*'" \
